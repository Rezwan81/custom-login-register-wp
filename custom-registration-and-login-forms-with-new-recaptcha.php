...
<div class="wshipping-register-block">
    <div class="container">
                    ...
                    <div class="row">
                      <div class="col-12 col-md-6 col-lg-6">
                       <label for="custom_user_Login"><?php _e('Username'); ?><span class="crlfwnr_required">*</span></label>
                        <input name="custom_user_login" id="custom_user_login" class="form-control required" type="text" value="<?php echo $_POST['custom_user_login']; ?>"/>
                    </div>

                      <div class="col-12 col-md-6 col-lg-6">
                        <label for="custom_user_email"><?php _e('Email'); ?><span class="crlfwnr_required">*</span></label>
                        <input name="custom_user_email" id="custom_user_email" class="form-control required" type="email" value="<?php echo $_POST['custom_user_email']; ?>"/>
                    </div>
                ...
                <div class="form-group">
                    <div class="row">
                      <div class="col-12 col-md-6 col-lg-6">
                        ...
                        <input name="custom_user_first" class="form-control" id="custom_user_first" type="text" value="<?php echo $_POST['custom_user_first']; ?>"/>
                     </div>
                      <div class="col-12 col-md-6 col-lg-6">
                         <label for="custom_user_last"><?php _e('Last Name'); ?></label>
                         <input name="custom_user_last" class="form-control" id="custom_user_last" type="text" value="<?php echo $_POST['custom_user_last']; ?>"/>
                       </div>
                    </div>    
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input name="custom_user_pass" id="password" class="form-control required" type="password" />
                      </div>
                      <div class="col-12 col-md-6 col-lg-6">
                      <label for="password_again"><?php _e('Password Again'); ?></label>
                        <input name="custom_user_pass_confirm" id="password_again" class="form-control required" type="password"/>
                      </div>
                    </div>    
                  </div>
                  <p> 
                    ...
                    <input type="submit" class="btn btn-submit" value="<?php _e('Register'); ?>"/>
                </form> 
            </div> 
         </div>
       </div>       
...
function crlfwnr_custom_login_form_fields() {
    ...
    ob_start(); ?>
        ...
        <div class="wshipping-login-block">
            <div class="container">
                <div class="customer-login">
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-6">
                            ...
                            <h2>Login To Your Account</h2>
                                <form id="crlfwnr_custom_login_form"  class="crlfwnr_custom_form" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input name="custom_user_login" id="custom_user_login" class="required form-control" type="text"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="custom_user_pass">Password <span class="crlfwnr_required">*</span></label>
                                        <input name="custom_user_pass" id="custom_user_pass" class="required form-control" type="password"/>
                                    </div>
                                        <input type="hidden" name="custom_login_nonce" value="<?php echo wp_create_nonce('custom-login-nonce'); ?>"/>
                                        <input id="custom_login_submit" type="submit" class="btn btn-submit" value="Login"/>
                                </form> 
                            </div> 
                        </div>
                    </div>       
